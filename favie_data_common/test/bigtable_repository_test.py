...
cf_config = {"address": "new_cf", "city": "new_cf"}
...
person_repository = BigtableRepository(
    ...
    derializer_config={"address": AddressDeserializer()},
)
...
def test_delete_models():
    persons = []
    for i in range(10, 30):
        persons.append(Person(id=f"B0000{i}", city="hangzhou" if i % 2 == 0 else "beijing"))
