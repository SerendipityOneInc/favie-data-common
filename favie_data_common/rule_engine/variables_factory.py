...
from favie_data_common.rule_engine.operators.favie_operators import FavieSelectMultipleType, FavieSelectType
        ...
        def bind_list_field_by_subfield(field_name: str, field_type: Any):
            ...
            for sub_field_name, _ in PydanticUtils.get_fields_of_pydantic_class(item_type):
                ...
                setattr(
                    ...
                    mark_list_field_getter(field_name, sub_field_name),
                )
